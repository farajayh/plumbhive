                ...
                <div class="col-md-8 col-lg-8 white mb-4 mx-md-0 mx-2" style=" border-radius: 10px;">
                    ...
                    <div class="row">
                      <div class="col-md-12 mt-4 mb-1">
                          ...
                          <p class="p-0 m-0" style="font-size:10px;">posted by <a href="" style="font-weight:bold; color: #004483;">{{$thread->user->name}} |</a> on {{$thread->created_at}} | 0 replies | Forum: <a href="" style="font-weight:bold; color: #004483;">Plumbing Marketing</a></p>
                          <hr>
                      </div>
                      <div class="col-md-12">
                          <p>
